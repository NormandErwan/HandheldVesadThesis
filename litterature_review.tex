...
\newenvironment{tableETS}[2]{
	\begin{table}
	\parbox{0.65\textwidth}{\caption{#1}\label{tableETS:#2}} % Contrainte manuelle de la largeur de la légende
	\centering
}{
	\end{table}
}
\newcommand{\reftableETS}[1]{(\emph{Voir} Tableau \ref{tableETS:#1})}
