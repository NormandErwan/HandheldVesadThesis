...
\figureLayoutETS{Errors}{%
  ...
  \figurehspace%
  \subfigureETS[0.25]{errors}{Nombre moyen d'erreurs.}%
}{
...
\figureETS[0.8]{selections_errors_distributions}{
...
Breaking selections down by \variable{GROUPE} \reffigureETSp{selections_ordering}, it appears that users committed more mistakes in the conditionvariable{Téléphone} condition when that was the first condition they experienced, suggesting that this technique was initially more prone to mistakes, possibly due to the limited screen size.

\figureETS[0.9]{selections_ordering}{
