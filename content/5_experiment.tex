...
Enfin, les utilisateurs ont porté le visiocasque de RA \autorefp{ch:methodology} dans toutes les conditions, même dans la condition \condition{Téléphone} qui ne bénéficie pas de la RA, pour garder identique le poids sur la tête ainsi que la même résolution et latence de l'image.
...
%\begin{itemize}
%  \item Temps de complétion, erreurs et nombre de sélections : le \condition{VESAD tactile} sera le meilleur et le \condition{VESAD} le moins bon, car le suivi de la main est imprécis pour ce dernier, alors que le \condition{VESAD tactile} bénéficie à la fois d'un grand écran \citep{Liu2014} et d'interactions stables et précises sur l'écran \citep{Jones2012}.
%  \item Nombre, temps et distance des défilements et des zooms : le \condition{Téléphone} sera le moins efficace (plus de défilements et zooms, plus longtemps et plus long), mais il ne devrait pas avoir de différence importante entre les deux autres techniques bénéficiant du grand écrans \citep{Raedle2014}.
...
%  \item Facilité de compréhension : le \condition{VESAD} sera un peu plus difficile à comprendre et demande un temps d'apprentissage plus long, car il comporte les deux nouveautés de l'écran étendu et du pointage avec une main virtuelle.
%  \item Exigence mentale, rapidité (temps de complétion) : pour les même raisons que les défilements et zooms, le petit écran impactera négativement le \condition{Téléphone}.
%  \item Exigence physique, frustration, performance (inclus rapidité et erreurs) : le \condition{VESAD} sera le plus fatigante car le pointage avec le doigt est plus difficile et lent en 3D qu'en 2D \citep{Argelaguet2013}, tandis que le \condition{VESAD tactile} sera le moins fatigante car le plus rapide.
%  \item Préférence : les participants classeront le \condition{VESAD} en premier, le \condition{VESAD tactile} en second et le \condition{Téléphone} en dernier, même si cela est en contradiction avec leurs performances, l'effet de nouveauté étant plus fort.
%\end{itemize}
