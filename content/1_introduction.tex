...
\figureETS{1_introduction_AR.png}{
  Illustrations publicitaires de la RA.\\
  À gauche, démonstration du HoloLens\footnote{text} ; à droite, démonstration de l'application de RA d'IKEA.
}

%\footnote{Tiré de Microsoft : \url{https://www.microsoft.com/fr-ca/hololens/why-hololens} (Consulté le 11 mars 2018)}
% \footnote{Tiré de Wikipedia : \url{https://commons.wikimedia.org/wiki/File:Augmented-reality.jpg} (Consulté le 11 mars 2018)}
