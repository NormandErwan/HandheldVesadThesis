...
Nous proposons de concevoir un prototype de téléphone intelligent tenu en main dont l'écran est étendu par RA et de l'évaluer expérimentalement par rapport à un téléphone seul non étendu. Nous appelons cette IHM : un téléphone augmenté par un \foreignlanguage{english}{Virtuality Extended Screen-Aligned Display} (VESAD), comme le montre la \reffigureETS{HandheldVESAD2018.png}.

\figureETS{HandheldVESADApps.png}{
...
\figureETS{HandheldVESADDogs.png}{
}

Une carte étendue

\figureETS{HandheldVESADMap.png}{
}

Aide

\figureETS{HandheldVESADTooltip.png}{
}
