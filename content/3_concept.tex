...
\begin{itemize}
  ...
  \item utiliser ensemble des fenêtres virtuelles et des objets réels, sans qu'il n'y ait de relations spatiales entre eux, en redirigant éventuellement entrées et sorties entre eux, comme dans Gluey ou Desktop-Gluey (côte à côte);
