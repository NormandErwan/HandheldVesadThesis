...
\begin{listingETS}{cs}{lst:aruco_camera_cs}{Extrait simplifié de la classe C\# ArucoCamera pour passer une image à OpenCV.}
...
Nous avons documenté chacune de ces classes. Ces informations se trovent également dans une documentation en ligne (\url{https://normanderwan.github.io/ArucoUnity/group__aruco__unity__package.html}) %TODO : mettre à jour le lien
...
\figureLayoutETS{ArucoUnityArchitecture2}{
  \begin{tikzpicture}
    \begin{umlpackage}{ArucoUnity}
      \begin{umlpackage}{Cameras}
        \umlsimpleclass[type=abstract]{ArucoCamera}
        \umlsimpleclass[y=-1.5, type=abstract]{ArucoCameraDisplay}
        \umlsimpleclass[y=-3, type=abstract]{ArucoCameraUndistortion}
        \umlsimpleclass[y=-4.5]{ArucoCameraCalibration}

        \umlsimpleclass[x=-6, y=-3.75]{CameraParameters}
        \umlHVHuniaggreg{ArucoCameraUndistortion}{CameraParameters}
        \umlHVHuniaggreg{ArucoCameraCalibration}{CameraParameters}
      \end{umlpackage}

      \umlsimpleclass[x=6, type=abstract]{ArucoCameraController}
      \umluniaggreg{ArucoCameraController}{ArucoCamera}
      \umlHVHinherit{ArucoCameraDisplay}{ArucoCameraController}
      \umlHVHinherit{ArucoCameraUndistortion}{ArucoCameraController}

      \umlsimpleclass[x=6, y=-2, type=abstract]{ArucoObjectDetector}
      \umlinherit{ArucoObjectDetector}{ArucoCameraController}
    \end{umlpackage}
  \end{tikzpicture}
}{bla}
...
\figureLayoutETS{ArucoUnityArchitecture}{
  \begin{tikzpicture}
    ...
    \umlsimpleclass[x=5, type=abstract]{ArucoCameraController}
    \umluniaggreg{ArucoCameraController}{ArucoCamera}

    \umlsimpleclass[y=-2, type=abstract]{ArucoCameraUndistortion}
    \umlVHVinherit{ArucoCameraUndistortion}{ArucoCameraController}
    \umlsimpleclass[x=0.6, y=-3.35]{CameraParameters}
    \umlVHuniaggreg[anchor1=-169]{ArucoCameraUndistortion}{CameraParameters}

    \umlsimpleclass[x=5, y=-2, type=abstract]{ArucoObjectDetector}
    \umlVHVinherit{ArucoObjectDetector}{ArucoCameraController}
    \umlsimpleclass[x=9, y=-3.5]{DetectorParameters}
    \umlVHuniaggreg[anchor1=-30]{ArucoObjectDetector}{DetectorParameters}

    \umlsimpleclass[x=10, y=-2, type=abstract]{ArucoCameraDisplay}
    \umlVHVinherit{ArucoCameraDisplay}{ArucoCameraController}

    \umlsimpleclass[y=-5, type=abstract]{ArucoCameraCalibration}
    \umlVHVinherit[arm1=0.75]{ArucoCameraCalibration}{ArucoObjectDetector}
    \umlVHuniaggreg[anchor1=167]{ArucoCameraCalibration}{CameraParameters}

    \umlsimpleclass[x=5, y=-5]{ArucoObjectsTracker}
    \umlVHVinherit[arm1=0.75]{ArucoObjectsTracker}{ArucoObjectDetector}

    \umlsimpleclass[x=10, y=-5, type=abstract]{ArucoObject}
    \umluniaggreg{ArucoObjectsTracker}{ArucoObject}

    \umlsimpleclass[x=10, y=-7]{ArucoDiamond}
    \umlVHVinherit{ArucoObject}{ArucoDiamond}

    \umlsimpleclass[x=5, y=-7]{ArucoMarker}
    \umlVHVinherit{ArucoObject}{ArucoMarker}

    \umlsimpleclass[y=-7, type=abstract]{ArucoBoard}
    \umlVHVinherit{ArucoObject}{ArucoBoard}

    \umlsimpleclass[y=-9]{ArucoGridBoard}
    \umlVHVinherit{ArucoBoard}{ArucoGridBoard}

    \umlsimpleclass[x=5, y=-9]{ArucoCharucoBoard}
    \umlVHVinherit{ArucoBoard}{ArucoCharucoBoard}
  \end{tikzpicture}
}{
  Diagramme de classes simplifé de la couche de scripts C\# d'ArucoUnity. Les classes notées en italique sont abstraites.
}
