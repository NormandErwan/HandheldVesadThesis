...
\figureLayoutETS{ovrvision_calibration}{%
  ...
  Vues d'une planche de calibration à travers l'Ovrvision Pro. L'importante distortion des images se remarque aux lignes parallèles de la planche qui sont courbées. L'étalonnage de la caméra mesure entre autres cette distorsion.
}
