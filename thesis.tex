...
\usepackage{textcomp} % Bon affichage de certains caratères comme \degree
\usepackage{csquotes} % Citations
\usepackage[binary-units=true]{siunitx} % Bon affichage des unités de mesure
\usepackage{pdfpages} % Pour inclure des pdfs en annexe
