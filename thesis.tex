...
\lstset{language=C++, style=VisualStudio}
\lstset{language=[Sharp]C, style=VisualStudio}
...
\lstdefinestyle{inline}{
  basicstyle=\ttfamily\small%
  \lst@ifdisplaystyle\scriptsize\fi% Scale font size, from https://tex.stackexchange.com/a/161551
}

\newcommand{\code}[2][{[Sharp]C}]{\lstinline[language={#1}, style=inline]|#2|}
